...
import 'package:latihan03/pages/tampilan_doc1.dart';
import 'package:latihan03/pages/tampilan_doc2.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const TampilanSatu()),
                    );
                  },
                  child: doctorCard(
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const TampilanDua()),
                    );
                  },
                  child: doctorCard(
                      "assets/img-doc2.png",
